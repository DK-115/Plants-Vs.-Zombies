...
public class Minion extends Actor {
	...
	public Minion(Double startingPosition, Double initHitbox, BufferedImage img, int health, int coolDown, double speed,
			int attackDamage) {
	...
	public void setCollisionStatus(Actor other) {
		if (other instanceof Fruit && this.isCollidingOther(other))
			setColliding(true);
	}
